...
})(["height:10vh;padding:0;margin:0;background:transparent;color:white;padding-top:2vh;font-size:1.5em;@media (max-width:776px){padding:0;margin:0;font-size:4em;}@media (min-width:767px){padding:0;margin:0;font-size:1.5em;}@media (min-width:1200px){padding:0;margin:0;}.fa.fa-navicon{color:white;font-size:1.75em;}a{color:white;}.navWrapper{position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);font-family:\"Oswald\",sans-serif;width:95vw;padding:0;margin:0;@media (max-width:767px){left:auto;top:auto;-webkit-transform:translate(0,0);transform:translate(0,0);}}.collapse{width:100%;}.nav-item{padding-left:2vw;text-align:center;@media (max-width:767px){z-index:9999;background:rgba(0,0,0,0.8);width:100%;}}"]);
...
//# sourceMappingURL=revelerProcess.js.190d6c2013727cc8a67b.hot-update.js.map