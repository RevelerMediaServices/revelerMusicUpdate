...
})(["position:absolute;left:50%;transform:translate(-50%,0%);-webkit-box-shadow:0 0 1vw rgba(154,154,154,1);-moz-box-shadow:0 0 1vw rgba(154,154,154,1);box-shadow:0 0 1vw rgba(154,154,154,1);width:75vw;background-color:black;border:solid 0.01vw rgba(0,0,100,1);margin:0;padding:0;.contactFormPageHeader{color:white;text-align:center;font-size:3vw;font-family:\"PT Sans\",sans-serif;@media only screen and (max-width:767px){font-size:6vw;}@media only screen and (max-width:1200px) and (min-width:767px){font-size:6vw;}}.newContactFormContainerDiv{text-align:center;color:white;font-family:\"PT Sans\",sans-serif;font-size:2vw;@media only screen and (max-width:767px){font-size:6.5vw;}@media only screen and (max-width:1200px) and (min-width:767px){font-size:2.5vw;}}.asLabel{padding-top:0.5vh;}.newContactFormButtonDiv{padding-top:2vh;padding-bottom:2vh;}.contactCards{background-color:transparent;margin-left:5%;margin-right:10%;margin-top:2vh;background-color:rgb(26,26,28,1);@media only screen and (max-width:1200px) and (min-width:767px){margin-left:5%;margin-right:10%;}@media only screen and (max-width:767px){margin-left:5%;margin-right:5%;}}.contactCardsWords{font-family:\"PT Sans\",sans-serif;font-size:1vw;@media only screen and (max-width:1200px) and (min-width:767px){font-size:1.5vw;}@media only screen and (max-width:767px){font-size:3vw;}}"]);
...
//# sourceMappingURL=contactInfo.js.5a955823f19d145259ec.hot-update.js.map