...
})(["color:white;margin:0;padding:0;width:100vw;#jName{font-size:2.5vw;position:absolute;top:65%;left:20%;font-family:\"Allerta Stencil\",sans-serif;font-weight:500;@media only screen and (max-width:767px){font-size:1.5vw;top:35%;left:5%;}@media only screen and (max-width:1200px) and (min-width:767px){font-size:2vw;top:60%;left:20%;}}#heatherName{text-align:center;font-size:2.5vw;position:absolute;top:35%;left:70%;font-family:\"Allerta Stencil\",sans-serif;font-weight:500;@media only screen and (max-width:767px){font-size:1.5vw;top:40%;left:63%;}@media only screen and (max-width:1200px) and (min-width:767px){font-size:2vw;top:35%;left:70%;}}#rmLogo{position:absolute;top:5%;left:50%;width:25vw;@media only screen and (max-width:767px){left:5%;width:70vw;}@media only screen and (max-width:1200px) and (min-width:767px){top:7%;left:55%;}}#jhLogo{position:absolute;top:58%;left:40%;img{width:16vw;}@media only screen and (max-width:767px){position:absolute;top:65%;left:10%;img{width:32vw;}}@media only screen and (max-width:1200px) and (min-width:767px){}}#cdLogo{position:absolute;top:68%;left:60%;img{width:16vw;}@media only screen and (max-width:767px){position:absolute;top:75%;left:55%;img{width:38vw;}}@media only screen and (max-width:1200px) and (min-width:767px){}}#landingPageWordsAtBottom{position:absolute;font-size:2vw;left:10%;bottom:6%;color:white;font-family:\"Luckiest Guy\",cursive;@media only screen and (max-width:767px){font-size:0.8vw;}@media only screen and (max-width:1200px) and (min-width:767px){font-size:1.8vw;left:6%;bottom:2%;}}#heatherLoveInstagram{position:absolute;font-size:1.5vw;left:65%;top:53%;color:white;font-family:\"Luckiest Guy\",cursive;img{width:3vw;}@media only screen and (max-width:767px){position:absolute;font-size:1.5vw;left:35%;top:20%;color:white;font-family:\"Luckiest Guy\",cursive;img{width:15vw;float:right;}}@media only screen and (max-width:1200px) and (min-width:767px){}}"]);
...
function Index() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    config: {
      ...
      description: "Next.js starter tvwplate with Styled-Components, Firebase, Next-SEO"
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 204
...
//# sourceMappingURL=index.js.874825a5f3896474e6c6.hot-update.js.map