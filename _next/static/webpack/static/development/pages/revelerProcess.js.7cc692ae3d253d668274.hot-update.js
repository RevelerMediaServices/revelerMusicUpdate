...
})(["color:white;text-align:justify;margin:0;padding:0;height:83vh;h1{text-align:center;}#pRevelerProcessGoal{margin-left:3vw;margin-right:3vw;background:rgba(0,0,0,0.5);border:solid white 0.02vw;padding:0.5vw;color:black;}img{width:10vw;height:auto;margin-left:auto;margin-right:auto;}.col{}.card{-webkit-box-shadow:0 0 1vw rgba(154,154,154,1);-moz-box-shadow:0 0 1vw rgba(154,154,154,1);box-shadow:0 0 1vw rgba(154,154,154,1);padding:1vw;}.card-title{text-align:center;}.card-subtitle{text-align:center;padding-bottom:3vh;}.card-text{padding:1vw;}"]);
...
//# sourceMappingURL=revelerProcess.js.7cc692ae3d253d668274.hot-update.js.map