...
})(["height:10vh;padding:0;margin:0;background:transparent;color:white;.fa.fa-navicon{color:white;font-size:1.75em;}a{color:white;}.navWrapper{background:yellow;}.collapse{background:orange;text-align:center;}.nav-item{@media (max-width:767px){z-index:9999;background:rgba(0,0,0,0.5);height:15vh;}}"]);
...
//# sourceMappingURL=index.js.ba4d69e3a8a0f6e3eb19.hot-update.js.map