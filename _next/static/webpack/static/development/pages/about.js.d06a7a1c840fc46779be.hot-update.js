...
})(["margin:0;padding:0;height:83vh;background:white;@media (max-width:1200px){min-height:100%;height:100%;}.row{margin:0;padding:0;}h1{font-size:4.855em;text-align:center;background:orange;height:15%;font-family:\"Fjalla One\",sans-serif;@media (min-width:576px){background:blue;}@media (min-width:992px){background:red;}@media (min-width:1200px){background:yellow;min-height:100%;}}h2{font-family:\"Special Elite\",cursive;font-size:2.427em;text-align:center;font-variant:small-caps;height:8%;}.colStyle{min-height:77%;background:red;}p{font-family:\"Special Elite\",cursive;font-size:1em;text-align:justify;font-family:\"Noto Sans\",sans-serif;}img{width:10vw;float:right;margin:0.5vw;}#imgRMBusCard{width:21vw;float:left;}#imgRMLogo{width:15vw;float:right;}#imgJ{width:13vw;float:right;outline:0.15vw dashed black;border:0.4vw solid white;}#imgHeather{width:12vw;float:left;margin-top:0.3vw;outline:0.15vw dashed black;border:0.4vw solid white;}"]);
...
//# sourceMappingURL=about.js.d06a7a1c840fc46779be.hot-update.js.map