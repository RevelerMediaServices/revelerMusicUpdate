...
})(["margin:0;padding:0;color:white;height:83vh;h1{text-align:center;margin:0;padding:0;}.row{margin:auto;width:98vw;}#pRevelerServicesGoal{margin-left:20vw;margin-right:20vw;}.colStyle{margin:0;padding:0;text-align:center;color:white;img{width:8vw;}@media only screen and (max-width:1200px) and (min-width:700px){padding-top:2vh;img{width:10vw;}}@media only screen and (max-width:700px){padding-top:2vh;img{width:23vw;}}}.card{background:rgba(0,0,0,0.6);height:50vh;width:100%;margin:0;padding:1vw;-webkit-box-shadow:0 0 1vw rgba(154,154,154,1);-moz-box-shadow:0 0 1vw rgba(154,154,154,1);box-shadow:0 0 1vw rgba(154,154,154,1);@media only screen and (max-width:1200px) and (min-width:700px){font-size:5vw;}@media only screen and (max-width:700px){}}.card-title{font-family:\"Montserrat\",sans-serif;font-size:2.5vw;font-weight:800;font-variant:small-caps;margin:0;padding:0;@media only screen and (max-width:1200px) and (min-width:700px){font-size:5vw;}@media only screen and (max-width:700px){font-size:10vw;}}.card-text{margin:0;padding:0;font-family:\"PT Serif\",serif;font-size:1em;font-weight:600;@media only screen and (max-width:1200px) and (min-width:700px){font-size:1em;}@media only screen and (max-width:700px){font-size:1em;}}"]);
...
function Services() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    __self: this
  }, "Reveler Music, LLC Entertainment Services"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
    id: "pRevelerServicesGoal",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 172
    },
    __self: this
  }, "Reveler's goal is to provide an amazing experience at a fair price. In order to guarantee the perfect experience within the budget, Reveler has a 4 step Experience Guarantee Process!"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_5__["Row"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 178
    },
...
//# sourceMappingURL=services.js.d3b96fc9b4ada7969e18.hot-update.js.map