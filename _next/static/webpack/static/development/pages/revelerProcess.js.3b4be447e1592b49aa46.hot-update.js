...
})(["color:white;text-align:justify;margin:0;padding:0;height:83vh;h1{text-align:center;}#pRevelerProcessGoal{margin-left:3vw;margin-right:3vw;background:rgba(154,154,154,0.5);border:solid white 0.2vw;}img{width:10vw;height:auto;margin-left:auto;margin-right:auto;}.col{}.card{-webkit-box-shadow:0 0 1vw rgba(154,154,154,1);-moz-box-shadow:0 0 1vw rgba(154,154,154,1);box-shadow:0 0 1vw rgba(154,154,154,1);padding:1vw;}.card-title{text-align:center;}.card-subtitle{text-align:center;padding-bottom:3vh;}.card-text{padding:1vw;}"]);
...
//# sourceMappingURL=revelerProcess.js.3b4be447e1592b49aa46.hot-update.js.map