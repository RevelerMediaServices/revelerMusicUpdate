...
})(["height:10vh;padding:0;margin:0;background:transparent;color:white;padding-top:2vh;font-size:1.5em;@media (max-width:576px){padding:0;margin:0;}@media (min-width:576px){padding:0;margin:0;font-size:5em;}@media (min-width:767px){padding:0;margin:0;font-size:1.5em;}@media (min-width:1200px){padding:0;margin:0;}.fa.fa-navicon{color:white;font-size:1.75em;}a{color:white;}.navWrapper{position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);font-family:\"Oswald\",sans-serif;width:100%;padding:0;margin:0;@media (max-width:767px){left:auto;top:auto;-webkit-transform:translate(0,0);transform:translate(0,0);padding:0;margin:0;}}.collapse{background:orange;text-align:center;padding:0;margin:0;}.nav-item{padding:0;margin:0;padding-left:2vw;@media (max-width:767px){z-index:9999;background:rgba(0,0,0,0.5);padding-left:0;padding:0;margin:0;}}"]);
...
//# sourceMappingURL=revelerProcess.js.06b5ca3e4cfe13a0b0ce.hot-update.js.map