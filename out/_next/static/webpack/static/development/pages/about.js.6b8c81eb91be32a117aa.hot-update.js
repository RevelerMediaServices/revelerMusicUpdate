...
})(["height:10vh;padding:0;margin:0;background:transparent;color:white;.fa.fa-navicon{color:white;font-size:1.75em;}a{color:white;}.navWrapper{background:yellow;width:100%;}.collapse{background:orange;text-align:center;}.nav-item{@media (max-width:767px){z-index:9999;background:rgba(0,0,0,0.5);height:15vh;}}"]);
...
//# sourceMappingURL=about.js.6b8c81eb91be32a117aa.hot-update.js.map