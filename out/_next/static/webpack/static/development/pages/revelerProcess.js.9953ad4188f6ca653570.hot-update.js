...
})(["height:10vh;padding:0;margin:0;background:transparent;color:white;padding-top:2vh;font-size:1.5em;@media (max-width:576px){padding:0;margin:0;font-size:4em;}@media (min-width:576px){padding:0;margin:0;font-size:5em;}@media (min-width:767px){padding:0;margin:0;font-size:1.5em;}@media (min-width:1200px){padding:0;margin:0;}.fa.fa-navicon{color:white;font-size:1.75em;}a{color:white;}.navWrapper{position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);font-family:\"Oswald\",sans-serif;@media (max-width:767px){left:auto;top:auto;-webkit-transform:translate(0,0);transform:translate(0,0);padding-bottom:2vh;padding-top:2vh;}}.collapse{background:orange;text-align:center;width:100%;}.nav-item{padding-left:2vw;@media (max-width:767px){z-index:9999;background:rgba(0,0,0,0.8);width:91vw;}}"]);
...
//# sourceMappingURL=revelerProcess.js.9953ad4188f6ca653570.hot-update.js.map