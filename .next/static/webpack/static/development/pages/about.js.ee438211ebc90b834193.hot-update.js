...
})(["margin:0;padding:1vw;background:white;height:80vh;h1{text-align:center;font-family:\"Fjalla One\",sans-serif;font-size:4.855vw;@media only screen and (max-width:767px){font-size:9.6vw;}@media only screen and (max-width:1200px) and (min-width:767px){}}h2{text-align:center;font-family:\"Fjalla One\",sans-serif;font-size:2.4vw;color:black;text-shadow:0.05vw 0.05vw 0.05vw rgba(255,255,255,1);height:6vh;margin-bottom:1vh;font-variant:small-caps;@media only screen and (max-width:767px){font-size:7.2vw;height:100%;}@media only screen and (max-width:1200px) and (min-width:767px){font-size:3.6vw;height:8vh;}}p{padding:0;font-family:\"Noto Sans\",sans-serif;font-size:1vw;width:100%;overflow-y:auto;@media only screen and (max-width:767px){font-size:5vw;height:100%;}@media only screen and (max-width:1200px) and (min-width:767px){font-size:2vw;height:100%;}}img{margin:1vw;@media only screen and (max-width:767px){}@media only screen and (max-width:1200px) and (min-width:767px){}}#imgRMBusCard{width:21vw;float:left;@media only screen and (max-width:767px){width:50vw;}@media only screen and (max-width:1200px) and (min-width:767px){width:30vw;}}#imgRMLogo{width:15vw;float:right;@media (max-width:576px){width:45vw;}}#imgJ{width:13vw;float:right;outline:0.15vw dashed black;border:0.4vw solid white;@media (max-width:576px){width:45vw;}}#imgHeather{width:12vw;float:left;margin-top:0.3vw;outline:0.15vw dashed black;border:0.4vw solid white;@media (max-width:576px){width:45vw;}}"]);
...
//# sourceMappingURL=about.js.ee438211ebc90b834193.hot-update.js.map