...
})(["margin:0;padding:0;height:83vh;background:white;@media (max-width:1200px){height:100%;}.row{margin:0;padding:0;}h1{font-size:4.855em;text-align:center;background:orange;height:15%;font-family:\"Fjalla One\",sans-serif;@media (max-width:576px){background:pink;}@media (min-width:576px){background:blue;}@media (min-width:992px){background:red;}@media (min-width:1200px){background:yellow;}}h2{font-family:\"Special Elite\",cursive;font-size:2.427em;text-align:center;font-variant:small-caps;height:8%;}p{font-family:\"Special Elite\",cursive;font-size:1em;text-align:justify;font-family:\"Noto Sans\",sans-serif;width:23vw;height:50vh;@media (max-width:576px){width:98vw;}@media (min-width:576px){width:46vw;}@media (min-width:992px){width:47vw;}@media (min-width:1200px){width:47vw;}}img{width:10vw;float:right;margin:0.5vw;}#imgRMBusCard{width:21vw;float:left;}#imgRMLogo{width:15vw;float:right;}#imgJ{width:13vw;float:right;outline:0.15vw dashed black;border:0.4vw solid white;}#imgHeather{width:12vw;float:left;margin-top:0.3vw;outline:0.15vw dashed black;border:0.4vw solid white;}"]);
...
//# sourceMappingURL=about.js.09c5c62f986b40010c67.hot-update.js.map