...
})(["height:10vh;padding:0;margin:0;background:transparent;color:white;.fa.fa-navicon{color:white;font-size:1.75em;}a{color:white;}.navWrapper{background:yellow;width:100%;text-align:center;}.collapse{background:orange;text-align:center;}.nav-item{@media (max-width:767px){z-index:9999;background:rgba(0,0,0,0.5);height:15vh;}}"]);
...
//# sourceMappingURL=index.js.156fbdcebcfdcd070d69.hot-update.js.map