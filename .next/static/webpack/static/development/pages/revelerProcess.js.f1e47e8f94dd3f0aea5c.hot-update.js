...
})(["color:white;text-align:justify;margin:0;padding:0;height:83vh;h1{text-align:center;}#pRevelerProcessGoal{margin-left:10vw;margin-right:10vw;background:rgba(255,255,255,0.5);border:solid white 0.02vw;padding:0.5vw;color:black;font-weight:800;text-align:justify;}img{width:10vw;height:auto;margin-left:auto;margin-right:auto;}.col{}.card{-webkit-box-shadow:0 0 1vw rgba(154,154,154,1);-moz-box-shadow:0 0 1vw rgba(154,154,154,1);box-shadow:0 0 1vw rgba(154,154,154,1);padding:1vw;}.card-title{text-align:center;}.card-subtitle{text-align:center;padding-bottom:3vh;}.card-text{padding:1vw;}"]);
...
//# sourceMappingURL=revelerProcess.js.f1e47e8f94dd3f0aea5c.hot-update.js.map