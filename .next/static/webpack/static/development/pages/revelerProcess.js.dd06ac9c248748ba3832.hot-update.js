...
})(["height:10%;padding:0;margin:0;background:transparent;color:white;padding-top:2vh;font-size:1.5em;font-family:\"Oswald\",sans-serif;background:yellow;position:fixed;width:100vw;max-width:100%;@media only screen and (max-width:767px){padding:0;margin:0;font-size:4em;}@media only screen and (max-width:1200px) and (min-width:700px){padding:0;margin:0;}.fa.fa-navicon{color:white;font-size:1.75em;}a{color:white;}.collapse{width:100%;}.nav-item{padding-left:2vw;text-align:center;@media only screen and (max-width:767px){z-index:9999;background:rgba(0,0,0,0.8);width:100%;margin:0;padding:0;}@media only screen and (max-width:1200px) and (min-width:700px){padding:0;margin:0;}}"]);
...
//# sourceMappingURL=revelerProcess.js.dd06ac9c248748ba3832.hot-update.js.map