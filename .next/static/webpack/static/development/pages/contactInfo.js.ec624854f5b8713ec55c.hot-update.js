...
})(["font-size:1.3em;background:rgba(0,0,0,0.8);padding-top:1vw;height:10%;position:fixed;bottom:0;width:100%;@media only screen and (max-width:767px){height:20vh;font-size:0.8em;}@media only screen and (max-width:1200px) and (min-width:700px){height:20vh;font-size:1em;}footer{}footer .menu li a{color:white;padding-left:0.5vw;padding-right:0.5vw;text-decoration:none;}footer .menu li a:hover{color:blue;}.fa.fa-facebook,.fa.fa-youtube-play,.fa.fa-instagram{color:#b1aca1;font-size:1.5em;padding-left:1vw;padding-right:1vw;}.fa.fa-facebook:hover,.fa.fa-youtube-play:hover,.fa.fa-instagram:hover{color:#6794c2;}"]);
...
//# sourceMappingURL=contactInfo.js.ec624854f5b8713ec55c.hot-update.js.map