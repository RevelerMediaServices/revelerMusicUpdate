...
})(["font-size:1.3em;background:rgba(0,0,0,0.8);height:10vh;position:fixed;bottom:0;width:100%;@media only screen and (max-width:767px){height:20vh;font-size:0.8em;}@media only screen and (max-width:1200px) and (min-width:700px){height:20vh;font-size:1em;}footer{}footer .menu li a{color:white;text-decoration:none;}footer .menu li a:hover{color:blue;}.fa.fa-facebook,.fa.fa-youtube-play,.fa.fa-instagram{color:#b1aca1;font-size:1.5em;}.fa.fa-facebook:hover,.fa.fa-youtube-play:hover,.fa.fa-instagram:hover{color:#6794c2;}"]);
...
//# sourceMappingURL=revelerProcess.js.c4c1b17db60e8c38a73d.hot-update.js.map