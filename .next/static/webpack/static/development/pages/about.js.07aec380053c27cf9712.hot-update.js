...
})(["font-size:1.5em;background:rgba(0,0,0,0.5);footer{background-color:transparent;height:7vh;padding-top:0.5vw;@media only screen and (max-width:1200px) and (min-width:700px){font-size:2.5em;}@media only screen and (max-width:767px){height:20vh;}}footer .menu li a{color:white;padding-left:0.5vw;padding-right:0.5vw;text-decoration:none;}footer .menu li a:hover{color:blue;}.fa.fa-facebook,.fa.fa-youtube-play,.fa.fa-instagram{color:#b1aca1;font-size:1.5em;padding-left:1vw;padding-right:1vw;}.fa.fa-facebook:hover,.fa.fa-youtube-play:hover,.fa.fa-instagram:hover{color:#6794c2;}"]);
...
//# sourceMappingURL=about.js.07aec380053c27cf9712.hot-update.js.map