...
})(["height:10vh;padding:0;margin:0;background:transparent;color:white;padding-top:2vh;font-size:1.5em;@media (max-width:576px){}@media (min-width:576px){}@media (min-width:767px){font-size:1em;}@media (min-width:1200px){}.fa.fa-navicon{color:white;font-size:1.75em;}a{color:white;}.navWrapper{position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);font-family:\"Oswald\",sans-serif;@media (max-width:767px){position:absolute;left:auto;top:auto;-webkit-transform:translate(0,0);transform:translate(0,0);width:100%;}}.collapse{background:orange;text-align:center;}.nav-item{padding-left:2vw;@media (max-width:767px){z-index:9999;background:rgba(0,0,0,0.5);height:15vh;}}"]);
...
function RMNavbar() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(RMNavbarDiv, {
    ...
    __self: this
  }, "The Process")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_1__["NavItem"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 113
    },
...
//# sourceMappingURL=revelerProcess.js.459ff4650eb144ac780c.hot-update.js.map