...
})(["height:10vh;padding:0;margin:0;background:transparent;color:white;.fa.fa-navicon{color:white;font-size:1.75em;}a{color:white;}.navWrapper{background:yellow;width:100%;margin:0 auto;}.collapse{background:orange;text-align:center;}.nav-item{@media (max-width:767px){z-index:9999;background:rgba(0,0,0,0.5);height:15vh;}}"]);
...
//# sourceMappingURL=index.js.d6e57cdab537debce357.hot-update.js.map