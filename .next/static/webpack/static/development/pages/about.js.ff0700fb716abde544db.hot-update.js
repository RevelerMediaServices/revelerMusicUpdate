...
})(["font-size:1.3em;background:rgba(0,0,0,0.8);padding:1vw;footer{height:10vh;padding-top:0.5vw;@media only screen and (max-width:767px){height:20vh;background-color:orange;}@media only screen and (max-width:1200px) and (min-width:700px){background-color:blue;}}footer .menu li a{color:white;padding-left:0.5vw;padding-right:0.5vw;text-decoration:none;}footer .menu li a:hover{color:blue;}.fa.fa-facebook,.fa.fa-youtube-play,.fa.fa-instagram{color:white;font-size:1.5em;padding-left:1vw;padding-right:1vw;}.fa.fa-facebook:hover,.fa.fa-youtube-play:hover,.fa.fa-instagram:hover{color:#6794c2;}"]);
...
//# sourceMappingURL=about.js.ff0700fb716abde544db.hot-update.js.map