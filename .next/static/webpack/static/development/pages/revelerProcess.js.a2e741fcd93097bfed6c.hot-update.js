...
})(["height:10vh;padding:0;margin:0;background:transparent;color:white;.fa.fa-navicon{color:white;font-size:1.75em;}a{color:white;}.navWrapper{position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);@media (max-width:767px){position:absolute;left:auto;top:auto;-webkit-transform:translate(0,0);transform:translate(0,0);}}.collapse{background:orange;text-align:center;}.nav-item{@media (max-width:767px){z-index:9999;background:rgba(0,0,0,0.5);height:15vh;}}"]);
...
//# sourceMappingURL=revelerProcess.js.a2e741fcd93097bfed6c.hot-update.js.map